...
local weather_widget = require("ui.widgets.text_weather")
local weather_widget_icon = require("ui.widgets.weather"):get_all_children()[1]
...
local dotw = require("ui.widgets.day_of_the_week")
...
-- Battery
local cute_battery_face = require("ui.widgets.cute_battery_face")
...
helpers.add_hover_cursor(playerctl, "hand1")
