...
local weather_widget = require("ui.widgets.sidebar.text_weather")
...
local temperature_bar = require("ui.widgets.sidebar.temperatur_bar")
...
local cpu_bar = require("ui.widgets.sidebar.cpu_bar")
...
local ram_bar = require("ui.widgets.sidebar.ram_bar")
...
local brightness_bar = require("ui.widgets.sidebar.brightness_bar")
...
-- Mpd
local mpd_buttons = require("ui.widgets.sidebar.song_buttons")
local mpd_song = require("ui.widgets.sidebar.song_title")
...
local volume_bar = require("ui.widgets.sidebar.volume_bar")
...
-- Battery
local battery_face = require("ui.widgets.sidebar.battery_face")
battery_face:buttons(gears.table.join(
...
awesome.connect_signal("evil::ram", function(value)
    ram_tooltip.markup = "You are using <span foreground='" .. beautiful.ram_bar_active_color .."'><b>" .. string.format("%.1f", value) .. "%</b></span> of memory"
end)
...
local battery_tooltip = create_tooltip(battery_face)
...
helpers.add_hover_cursor(battery_face, "hand1")
