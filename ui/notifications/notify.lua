...
naughty.connect_signal("request::display", function(n)
    ...
    elseif n.icon == nil then
        n.icon = icons.getIcon(
                     "beautyline/apps/scalable/preferences-desktop-notification.svg")
    end

    local notify_icon = naughty.widget.icon

    local function returnIcon() return notify_icon end
    ...
    naughty.layout.box {
        ...
        maximum_width = beautiful.notification_max_width or dpi(350),
        maximum_height = beautiful.notification_max_height or dpi(180),
        widget_template = {
            {
                {
    ...
    local slide = rubato.timed {
        ...
        subscribed = function(pos)
            naughty.layout.box.maximum_width = pos
        end
    }
    ...
    local timer = gears.timer {
        timeout = 5,
        single_shot = true,
        callback = function() slide.target = 0 end
    }

    slide.target = beautiful.notification_max_width or dpi(350)
    timer:start()
