...
awful.layout.layouts = { awful.layout.suit.floating, awful.layout.suit.tile, -- awful.layout.suit.spiral,
  ...
  bling.layout.mstab, bling.layout.centered,
...
awful.screen.connect_for_each_screen(function(s)
  ...
  -- Tag layouts
  local layouts = { l.floating, l.floating, l.floating, l.floating, l.floating, l.floating, l.floating, l.floating,
...
awful.rules.rules = { {
...
}, -- Floating clients
  {
    rule_any = {
      ...
      class = { "Gpick", "Lxappearance", "Nm-connection-editor", "File-roller", "fst", "Nvidia-settings" },
  ...
  {
    rule_any = {
      class = { "lt-love", "portal2_linux", "csgo_linux64", "EtG.x86_64", "factorio", "dota2", "Terraria.bin.x86",
        "dontstarve_steam" },
  ...
  -- Centered clients
  {
    rule_any = {
      type = { "dialog" },
      class = { "Steam", "discord", "music", "markdown_input", "scratchpad" },
  ...
  }, -- Titlebars OFF (explicitly)
  {
    rule_any = {
      ...
      type = { "splash" },
      name = { "^discord.com is sharing your screen.$" -- Discord (running in browser) screen sharing popup
      }
    },
    callback = function(c)
      decorations.hide(c)
  ...
  {
    rule_any = {
      class = { "Alacritty", "Termite", "mpvtube", "kitty", "st-256color", "st", "URxvt" }
    },
    properties = {
  ...
  {
    rule = {
      name = "Steam Guard - Computer Authorization Required"
    },
    properties = {
      floating = true
    }
  ...
  {
    rule = {
      instance = "league of legends.exe"
    },
    properties = {},
    callback = function(c)
      local matcher = function(c)
        return awful.rules.match(c, {
          instance = "leagueclientux.exe"
        })
      end
