...
awful.layout.layouts = {
    awful.layout.suit.floating, awful.layout.suit.tile, -- awful.layout.suit.spiral,
    ...
    bling.layout.mstab, bling.layout.centered, --    bling.layout.vertical,
...
awful.rules.rules = {
    ...
    }, -- Floating clients
    {
        rule_any = {
            instance = {
                ...
                "floating_terminal", "riotclientux.exe", "leagueclientux.exe",
                "Devtools" -- Firefox devtools
            },
            class = {
                "Gpick", "Lxappearance", "Nm-connection-editor", "File-roller",
                "fst", "Nvidia-settings"
            },
            name = {
                "Event Tester", -- xev
    ...
    }, -- Fullscreen clients
    {
        rule_any = {
            class = {
                "lt-love", "portal2_linux", "csgo_linux64", "EtG.x86_64",
                "factorio", "dota2", "Terraria.bin.x86", "dontstarve_steam"
            },
    ...
    }, -- Titlebars OFF (explicitly)
    {
        rule_any = {
            instance = {
                ...
                "gw2-64.exe", "battle.net.exe", "riotclientservices.exe",
                "leagueclientux.exe", "riotclientux.exe", "leagueclient.exe",
                "^editor$", "markdown_input"
            },
            class = {
                "qutebrowser", "Sublime_text", "Subl3", "spad", -- "discord",
                -- "TelegramDesktop",
                "Conky", "Nightly", "Steam", "Lutris", "Chromium", "^editor$",
    ...
    }, -- Fixed terminal geometry for floating terminals
    {
        rule_any = {
            class = {
                "Alacritty", "Termite", "mpvtube", "kitty", "st-256color", "st",
                "URxvt"
            }
        },
